...
<c:set var="req" value="${pageContext.request.contextPath}" />
	...
	<div class="panel panel-primary">
      ...
      <div class="panel-body">
		...
		<form:form action="${req}/pro/save" method="post" modelAttribute="regdtl" enctype="multipart/form-data">
			<table border="5" width="800" align="center" >
				...
				<tr class="success">
					...
					<form:input  path="file" type="file" cssClass="form-control" placeholder="Select File"
							required="required"/>

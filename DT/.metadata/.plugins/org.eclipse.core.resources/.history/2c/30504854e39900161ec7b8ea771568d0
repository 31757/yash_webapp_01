...
.rights {
	...
	border-top: solid 1px rgba(103, 58, 183, 0.3)
}
...
<div class="panel panel-primary">
	...
	<div class="panel-body">
		...
		<form:form action="${req}/pro/save" method="post"
			modelAttribute="regdtl" enctype="multipart/form-data">
			<table border="5" width="800" align="center">
				...
				<tr class="success">
					...
					<td class="table-info"><form:input path="pos"
							cssClass="form-control" /></td>

				</tr>
				<tr class="success">
					<td class="info">Product Version</td>
					<td class="table-info"><form:input path="pversion"
							cssClass="form-control" /></td>
				...
				<tr class="success">
					<td colspan=2 align="center"><form:hidden path="purl" /> <form:input
						...
						src="${req}/resources/images/${product.purl}" /></td>
				</tr>

        ...
        <div class="row text-center">
            ...
            <div class="col-md-3 col-sm-6 hero-feature">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        <h3>TV</h3>
                        <p>A different collection of TV and others for the all type of people at great price   </p> 
                        <p>
                            <a href="#" class="btn btn-primary">Buy Now!</a> 
                        </p>
                    </div>
            ...
            <div class="col-md-3 col-sm-6 hero-feature">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        <h3>Mobiles</h3>
                        <p>Hot and Cool phones in different styles for the everyone in all designs with modern configuration and style</p>
                        <p>
                            <a href="#" class="btn btn-primary">Buy Now!</a> 
                        </p>
                    </div>

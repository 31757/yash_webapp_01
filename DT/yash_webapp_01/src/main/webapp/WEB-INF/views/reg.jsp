...
&nbsp;
  ...
  <h3 align="center">Sign up now to get loads of discount..........!</h3>
...
<form:form method="POST" action="${cp}/reg/save" modelAttribute="user">
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    <form:input path="name" class="form-control"
							placeholder="User Name" required="required" size="35"/>
							<form:errors path="name" style="color:red;" />
                  </div>
                  <div class="form-group">
                     <form:input path="email" type="email" class="form-control"
							placeholder="User email" required="required" size="35"/>
							<form:errors path="email" style="color:red;" />
                  </div>
                        <div class="form-group">
                    <form:input path="password" type="password" class="form-control"
							placeholder="User Password" required="required" size="20"/>
							<form:errors path="password" style="color:red;" />
                  </div>
                  <div class="form-group">
                    <form:input path="password" type="address" class="form-control"
							placeholder="Enter your address" required="required" size="35"/>
							<form:errors path="address" style="color:red;" />
                  </div>
                  
                        <div class="form-group">
                    <form:hidden path="enabled" value="true" required="required"/>
      ...
      <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" required="required"> Please accept the terms and conditions to proceed with your request.
                      </label>
                    </div>
                  </div>
                  <div class="form-group">
